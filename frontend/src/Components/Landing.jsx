  ...
  return (
    <div className="flex w-full items-center justify-center min-h-screen bg-[#F0F8FF]">
      ...
      <div className="flex flex-col items-center justify-center gap-8 lg:w-1/2 w-full px-6 py-4">
        <p className="text-[#3C0663] text-7xl font-bold">
          <span>
            <Typewriter
              words={["SayIt", "SayIt"]}
              loop={"autostart"}
        ...
        <p className="text-2xl text-[#3C0663] font-semibold italic">
        ...
        <button
          ...
          className="bg-[#3C0663] text-[#F8F6E3] font-semibold p-3 lg:w-[30%] w-1/2 rounded-full hover:bg-[#4A0A77] hover:text-white"
        >
          Get Started ↪{" "}
        </button>
      </div>
