...
// import Polarity from "./Polarity"; // Import the Polarity component

// const Review = ({ product }) => {
//   const { name, imagePath, description, price, rating, brand, category, reviews } =
...
//     const newReview = {
//       id: reviews.length + 1, // Generate a unique ID for the new review
//       reviewer: reviewer,
//       review: reviewText
//     };
//     const updatedReviews = [...reviews, newReview];

//     // Here you can send the updated reviews list to your backend or handle it as needed
